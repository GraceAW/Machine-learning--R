...
From the diagram we can see both x1 and x2 are statistically significant.
### 1c)
...
There are 9 features in the model. intercept,x1,x1^2,x2^2 are statistically significant, and x1:x2 and x1:I(x2^2) are boundary features.
### 1e)
